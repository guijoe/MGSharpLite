...
namespace MGSharp
{
    class SingleLayerRosetteFormation: Simulator
    {
        public static void Main(string[] args)
        {
            Simulator simulator = new SingleLayerRosetteFormation();
            Simulator.name = "SingleLayerRosetteFormation";
        ...
        public override void SetupSimulation()
        {
            ...
            //Cylinder34 mesh = new Cylinder34(new Vector(.5f,1,.5f), false);
            HexagonalCylinder42 mesh = new HexagonalCylinder42(.5f);

            Tissue t1 = new Tissue(25, popMaxSize, mesh);
            ...
            Helper.SetNCubedInHexa(popMaxSize);
